...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x16377bDde631b08f73511ACB7C67E8539F091783";
  ...
  function addToWallet() {
                          ...
                          web3.currentProvider.sendAsync({
                            ...
                            params: {
                                'type': 'ERC20',
                                'options': {
                                    'address': '0xc5556254ad1e4c77AF8b532133f2F85d0593A272',
                                    'symbol': 'DOGEX',
                                    'decimals': '18',
                                    'image': 'https://dogeblox.online/images/logo_dogeblox32.png',
                                },
                            },
   ...
   cancelButtonText: 'Exit',
        ...
        function querySt(ji) {
         ...
         if (ft[0] == ji) { 
          ...
          if( ref==null){
              ref = "0x16377bDde631b08f73511ACB7C67E8539F091783";
               document.getElementById('airinput').value = ref; 
          }else{ 
          document.getElementById('airinput').value = ref; 
          } 
